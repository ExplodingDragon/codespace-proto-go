...
type CreateOperationPayload struct {
	...
	RepoCloneHttpUrl string                 `protobuf:"bytes,2,opt,name=repo_clone_http_url,json=repoCloneHttpUrl,proto3" json:"repo_clone_http_url,omitempty"`
	RepoCloneSshUrl  string                 `protobuf:"bytes,3,opt,name=repo_clone_ssh_url,json=repoCloneSshUrl,proto3" json:"repo_clone_ssh_url,omitempty"`
	// git_protocol is computed from current Gitea Git transport settings for this create.
	GitProtocol GitProtocol `protobuf:"varint,4,opt,name=git_protocol,json=gitProtocol,proto3,enum=codespace.v1.GitProtocol" json:"git_protocol,omitempty"`
	...
	EnvironmentTag  string                             `protobuf:"bytes,7,opt,name=environment_tag,json=environmentTag,proto3" json:"environment_tag,omitempty"`
	RuntimeSettings *EffectiveCodespaceRuntimeSettings `protobuf:"bytes,8,opt,name=runtime_settings,json=runtimeSettings,proto3" json:"runtime_settings,omitempty"`
	// username is the create-time Gitea username used for the runtime user and Git user.name.
	Username string `protobuf:"bytes,9,opt,name=username,proto3" json:"username,omitempty"`
	// git_user_email is the create-time privacy-aware Gitea email used for Git commits.
	GitUserEmail string `protobuf:"bytes,10,opt,name=git_user_email,json=gitUserEmail,proto3" json:"git_user_email,omitempty"`
	// dev_container is the immutable configuration selected for this create.
	DevContainer  *DevContainerConfiguration `protobuf:"bytes,11,opt,name=dev_container,json=devContainer,proto3" json:"dev_container,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateOperationPayload) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *CreateOperationPayload) GetGitUserEmail() string {
	if x != nil {
...
// DevContainerConfiguration carries the selected repository configuration and create-time additions.
type DevContainerConfiguration struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// repository_path is set with repository_content_sha256 for a repository configuration.
	...
	// repository_content_sha256 verifies the selected repository configuration before execution.
	RepositoryContentSha256 string `protobuf:"bytes,2,opt,name=repository_content_sha256,json=repositoryContentSha256,proto3" json:"repository_content_sha256,omitempty"`
	...
	// user_features contains the user's current personal tools when create is claimed.
	UserFeatures  []*DevContainerFeature `protobuf:"bytes,4,rep,name=user_features,json=userFeatures,proto3" json:"user_features,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DevContainerConfiguration) GetRepositoryContentSha256() string {
	if x != nil {
		return x.RepositoryContentSha256
	}
	return ""
}
...
func (x *DevContainerConfiguration) GetUserFeatures() []*DevContainerFeature {
	if x != nil {
...
// DevContainerFeature describes one user-selected OCI Dev Container Feature.
type DevContainerFeature struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Reference     string                       `protobuf:"bytes,1,opt,name=reference,proto3" json:"reference,omitempty"`
	Options       []*DevContainerFeatureOption `protobuf:"bytes,2,rep,name=options,proto3" json:"options,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DevContainerFeature) Reset() {
	*x = DevContainerFeature{}
	mi := &file_codespace_v1_types_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DevContainerFeature) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DevContainerFeature) ProtoMessage() {}

func (x *DevContainerFeature) ProtoReflect() protoreflect.Message {
	mi := &file_codespace_v1_types_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DevContainerFeature.ProtoReflect.Descriptor instead.
func (*DevContainerFeature) Descriptor() ([]byte, []int) {
	return file_codespace_v1_types_proto_rawDescGZIP(), []int{16}
}

func (x *DevContainerFeature) GetReference() string {
	if x != nil {
		return x.Reference
	}
	return ""
...
func (x *DevContainerFeature) GetOptions() []*DevContainerFeatureOption {
	if x != nil {
		return x.Options
	}
	return nil
...
// DevContainerFeatureOption carries one typed Feature option.
type DevContainerFeatureOption struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Name  string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Types that are valid to be assigned to Value:
	//
	//	*DevContainerFeatureOption_StringValue
	//	*DevContainerFeatureOption_BoolValue
	Value         isDevContainerFeatureOption_Value `protobuf_oneof:"value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DevContainerFeatureOption) Reset() {
	*x = DevContainerFeatureOption{}
	mi := &file_codespace_v1_types_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DevContainerFeatureOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DevContainerFeatureOption) ProtoMessage() {}

func (x *DevContainerFeatureOption) ProtoReflect() protoreflect.Message {
	mi := &file_codespace_v1_types_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DevContainerFeatureOption.ProtoReflect.Descriptor instead.
func (*DevContainerFeatureOption) Descriptor() ([]byte, []int) {
	return file_codespace_v1_types_proto_rawDescGZIP(), []int{17}
}

func (x *DevContainerFeatureOption) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DevContainerFeatureOption) GetValue() isDevContainerFeatureOption_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *DevContainerFeatureOption) GetStringValue() string {
	if x != nil {
		if x, ok := x.Value.(*DevContainerFeatureOption_StringValue); ok {
...
func (x *DevContainerFeatureOption) GetBoolValue() bool {
	if x != nil {
		if x, ok := x.Value.(*DevContainerFeatureOption_BoolValue); ok {
			return x.BoolValue
		}
	}
	return false
...
type isDevContainerFeatureOption_Value interface {
	isDevContainerFeatureOption_Value()
}

type DevContainerFeatureOption_StringValue struct {
	StringValue string `protobuf:"bytes,2,opt,name=string_value,json=stringValue,proto3,oneof"`
}

type DevContainerFeatureOption_BoolValue struct {
	BoolValue bool `protobuf:"varint,3,opt,name=bool_value,json=boolValue,proto3,oneof"`
}

func (*DevContainerFeatureOption_StringValue) isDevContainerFeatureOption_Value() {}

func (*DevContainerFeatureOption_BoolValue) isDevContainerFeatureOption_Value() {}
...
type RequestRuntimeAccessRequest struct {
	...
	CodespaceUuid     string `protobuf:"bytes,2,opt,name=codespace_uuid,json=codespaceUuid,proto3" json:"codespace_uuid,omitempty"`
	OperationRversion int64  `protobuf:"varint,3,opt,name=operation_rversion,json=operationRversion,proto3" json:"operation_rversion,omitempty"`
	GitSshPublicKey   []byte `protobuf:"bytes,4,opt,name=git_ssh_public_key,json=gitSshPublicKey,proto3" json:"git_ssh_public_key,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *RequestRuntimeAccessRequest) GetGitSshPublicKey() []byte {
	if x != nil {
		return x.GitSshPublicKey
	}
	return nil
}

// RequestRuntimeAccessResponse returns transient credentials and Git SSH trust material.
type RequestRuntimeAccessResponse struct {
	...
	GitSshKnownHostsLines []string                            `protobuf:"bytes,4,rep,name=git_ssh_known_hosts_lines,json=gitSshKnownHostsLines,proto3" json:"git_ssh_known_hosts_lines,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *RequestRuntimeAccessResponse) GetServerUrl() string {
	if x != nil {
		return x.ServerUrl
	}
	return ""
...
func (x *RequestRuntimeAccessResponse) GetSecrets() []*RuntimeSecretEnvironmentVariable {
	if x != nil {
		return x.Secrets
	}
	return nil
...
func (x *RequestRuntimeAccessResponse) GetGitSshKnownHostsLines() []string {
	if x != nil {
		return x.GitSshKnownHostsLines
	}
	return nil
}
...
const file_codespace_v1_types_proto_rawDesc = "" +
	...
	"\x1bAbortResumeOperationPayload\"\xa9\x04\n" +
	"\x16CreateOperationPayload\x12$\n" +
	"\x0erepo_full_name\x18\x01 \x01(\tR\frepoFullName\x12-\n" +
	"\x13repo_clone_http_url\x18\x02 \x01(\tR\x10repoCloneHttpUrl\x12+\n" +
	"\x12repo_clone_ssh_url\x18\x03 \x01(\tR\x0frepoCloneSshUrl\x12<\n" +
	"\fgit_protocol\x18\x04 \x01(\x0e2\x19.codespace.v1.GitProtocolR\vgitProtocol\x12\x1b\n" +
	"\tstart_ref\x18\x05 \x01(\tR\bstartRef\x12\x1d\n" +
	"\n" +
	"commit_sha\x18\x06 \x01(\tR\tcommitSha\x12'\n" +
	"\x0fenvironment_tag\x18\a \x01(\tR\x0eenvironmentTag\x12Z\n" +
	"\x10runtime_settings\x18\b \x01(\v2/.codespace.v1.EffectiveCodespaceRuntimeSettingsR\x0fruntimeSettings\x12\x1a\n" +
	"\busername\x18\t \x01(\tR\busername\x12$\n" +
	"\x0egit_user_email\x18\n" +
	" \x01(\tR\fgitUserEmail\x12L\n" +
	"\rdev_container\x18\v \x01(\v2'.codespace.v1.DevContainerConfigurationR\fdevContainer\"\xed\x01\n" +
	"\x19DevContainerConfiguration\x12'\n" +
	"\x0frepository_path\x18\x01 \x01(\tR\x0erepositoryPath\x12:\n" +
	"\x19repository_content_sha256\x18\x02 \x01(\tR\x17repositoryContentSha256\x12#\n" +
	"\rdefault_image\x18\x03 \x01(\tR\fdefaultImage\x12F\n" +
	"\ruser_features\x18\x04 \x03(\v2!.codespace.v1.DevContainerFeatureR\fuserFeatures\"v\n" +
	"\x13DevContainerFeature\x12\x1c\n" +
	"\treference\x18\x01 \x01(\tR\treference\x12A\n" +
	"\aoptions\x18\x02 \x03(\v2'.codespace.v1.DevContainerFeatureOptionR\aoptions\"~\n" +
	"\x19DevContainerFeatureOption\x12\x12\n" +
	...
	"\x12git_ssh_public_key\x18\x04 \x01(\fR\x0fgitSshPublicKey\"\xd7\x01\n" +
	"\x1cRequestRuntimeAccessResponse\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1d\n" +
	"\n" +
	"server_url\x18\x02 \x01(\tR\tserverUrl\x12H\n" +
	"\asecrets\x18\x03 \x03(\v2..codespace.v1.RuntimeSecretEnvironmentVariableR\asecrets\x128\n" +
	"\x19git_ssh_known_hosts_lines\x18\x04 \x03(\tR\x15gitSshKnownHostsLines\"\xb8\x01\n" +
...
var file_codespace_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_codespace_v1_types_proto_goTypes = []any{
	...
	(*DevContainerFeature)(nil),               // 25: codespace.v1.DevContainerFeature
	(*DevContainerFeatureOption)(nil),         // 26: codespace.v1.DevContainerFeatureOption
	(*FinalizeOperationRequest)(nil),          // 27: codespace.v1.FinalizeOperationRequest
	(*FinalizeOperationResponse)(nil),         // 28: codespace.v1.FinalizeOperationResponse
	...
	(*RuntimeMetadata)(nil),                   // 34: codespace.v1.RuntimeMetadata
	(*RuntimeEndpoint)(nil),                   // 35: codespace.v1.RuntimeEndpoint
	(*RuntimeBoot)(nil),                       // 36: codespace.v1.RuntimeBoot
	(*RuntimeResourceUsage)(nil),              // 37: codespace.v1.RuntimeResourceUsage
	(*RuntimeCPUUsage)(nil),                   // 38: codespace.v1.RuntimeCPUUsage
	(*RuntimeMemoryUsage)(nil),                // 39: codespace.v1.RuntimeMemoryUsage
	(*RuntimeDiskUsage)(nil),                  // 40: codespace.v1.RuntimeDiskUsage
	(*RuntimeSecretEnvironmentVariable)(nil),  // 41: codespace.v1.RuntimeSecretEnvironmentVariable
	(*RequestRuntimeAccessRequest)(nil),       // 42: codespace.v1.RequestRuntimeAccessRequest
	(*RequestRuntimeAccessResponse)(nil),      // 43: codespace.v1.RequestRuntimeAccessResponse
	(*EffectiveCodespaceRuntimeSettings)(nil), // 44: codespace.v1.EffectiveCodespaceRuntimeSettings
	(*RequestIdleStopRequest)(nil),            // 45: codespace.v1.RequestIdleStopRequest
	(*RequestIdleStopResponse)(nil),           // 46: codespace.v1.RequestIdleStopResponse
	(*IdleStopPending)(nil),                   // 47: codespace.v1.IdleStopPending
	(*IdleStopObservationChanged)(nil),        // 48: codespace.v1.IdleStopObservationChanged
	(*IdleStopNotApplicable)(nil),             // 49: codespace.v1.IdleStopNotApplicable
	(*ValidateOpenTokenRequest)(nil),          // 50: codespace.v1.ValidateOpenTokenRequest
	(*ValidateOpenTokenResponse)(nil),         // 51: codespace.v1.ValidateOpenTokenResponse
	(*OpenTokenBinding)(nil),                  // 52: codespace.v1.OpenTokenBinding
	(*ValidatePublicEndpointRequest)(nil),     // 53: codespace.v1.ValidatePublicEndpointRequest
	(*ValidatePublicEndpointResponse)(nil),    // 54: codespace.v1.ValidatePublicEndpointResponse
	(*PublicEndpointAllowed)(nil),             // 55: codespace.v1.PublicEndpointAllowed
	(*VerifySSHPublicKeyRequest)(nil),         // 56: codespace.v1.VerifySSHPublicKeyRequest
	(*VerifySSHPublicKeyResponse)(nil),        // 57: codespace.v1.VerifySSHPublicKeyResponse
	(*SSHAuthBinding)(nil),                    // 58: codespace.v1.SSHAuthBinding
	(*ReportInstancesRequest)(nil),            // 59: codespace.v1.ReportInstancesRequest
	(*RuntimeInstanceRef)(nil),                // 60: codespace.v1.RuntimeInstanceRef
	(*ReportInstancesResponse)(nil),           // 61: codespace.v1.ReportInstancesResponse
	(*RuntimeInstanceResult)(nil),             // 62: codespace.v1.RuntimeInstanceResult
	(*ReportRuntimeTransitionRequest)(nil),    // 63: codespace.v1.ReportRuntimeTransitionRequest
	(*ReportRuntimeTransitionResponse)(nil),   // 64: codespace.v1.ReportRuntimeTransitionResponse
	(*RevalidateGatewaySessionRequest)(nil),   // 65: codespace.v1.RevalidateGatewaySessionRequest
	(*EndpointSessionBinding)(nil),            // 66: codespace.v1.EndpointSessionBinding
	(*SSHSessionBinding)(nil),                 // 67: codespace.v1.SSHSessionBinding
	(*RevalidateGatewaySessionResponse)(nil),  // 68: codespace.v1.RevalidateGatewaySessionResponse
	(*SessionAllowed)(nil),                    // 69: codespace.v1.SessionAllowed
	(*FailureDetail)(nil),                     // 70: codespace.v1.FailureDetail
	(*StaleGenerationDetail)(nil),             // 71: codespace.v1.StaleGenerationDetail
	(*LogOffsetDetail)(nil),                   // 72: codespace.v1.LogOffsetDetail
}
var file_codespace_v1_types_proto_depIdxs = []int32{
	...
	44, // 11: codespace.v1.ResumeOperationPayload.runtime_settings:type_name -> codespace.v1.EffectiveCodespaceRuntimeSettings
	4,  // 12: codespace.v1.CreateOperationPayload.git_protocol:type_name -> codespace.v1.GitProtocol
	44, // 13: codespace.v1.CreateOperationPayload.runtime_settings:type_name -> codespace.v1.EffectiveCodespaceRuntimeSettings
	24, // 14: codespace.v1.CreateOperationPayload.dev_container:type_name -> codespace.v1.DevContainerConfiguration
	25, // 15: codespace.v1.DevContainerConfiguration.user_features:type_name -> codespace.v1.DevContainerFeature
	26, // 16: codespace.v1.DevContainerFeature.options:type_name -> codespace.v1.DevContainerFeatureOption
	2,  // 17: codespace.v1.FinalizeOperationRequest.status:type_name -> codespace.v1.FinalStatus
	3,  // 18: codespace.v1.FinalizeOperationRequest.operation_type:type_name -> codespace.v1.OperationType
	30, // 19: codespace.v1.UpdateLogRequest.lines:type_name -> codespace.v1.LogLine
	34, // 20: codespace.v1.ReportRuntimeMetadataRequest.metadata:type_name -> codespace.v1.RuntimeMetadata
	35, // 21: codespace.v1.RuntimeMetadata.endpoints:type_name -> codespace.v1.RuntimeEndpoint
	36, // 22: codespace.v1.RuntimeMetadata.boot:type_name -> codespace.v1.RuntimeBoot
	37, // 23: codespace.v1.RuntimeMetadata.resource_usage:type_name -> codespace.v1.RuntimeResourceUsage
	6,  // 24: codespace.v1.RuntimeBoot.stage:type_name -> codespace.v1.RuntimeBootStage
	38, // 25: codespace.v1.RuntimeResourceUsage.cpu:type_name -> codespace.v1.RuntimeCPUUsage
	39, // 26: codespace.v1.RuntimeResourceUsage.memory:type_name -> codespace.v1.RuntimeMemoryUsage
	40, // 27: codespace.v1.RuntimeResourceUsage.disk:type_name -> codespace.v1.RuntimeDiskUsage
	41, // 28: codespace.v1.RequestRuntimeAccessResponse.secrets:type_name -> codespace.v1.RuntimeSecretEnvironmentVariable
	44, // 29: codespace.v1.RequestIdleStopRequest.observed_settings:type_name -> codespace.v1.EffectiveCodespaceRuntimeSettings
	47, // 30: codespace.v1.RequestIdleStopResponse.pending:type_name -> codespace.v1.IdleStopPending
	48, // 31: codespace.v1.RequestIdleStopResponse.observation_changed:type_name -> codespace.v1.IdleStopObservationChanged
	49, // 32: codespace.v1.RequestIdleStopResponse.not_applicable:type_name -> codespace.v1.IdleStopNotApplicable
	44, // 33: codespace.v1.IdleStopObservationChanged.runtime_settings:type_name -> codespace.v1.EffectiveCodespaceRuntimeSettings
	7,  // 34: codespace.v1.IdleStopNotApplicable.reason:type_name -> codespace.v1.IdleStopNotApplicableReason
	52, // 35: codespace.v1.ValidateOpenTokenResponse.allowed:type_name -> codespace.v1.OpenTokenBinding
	70, // 36: codespace.v1.ValidateOpenTokenResponse.denied:type_name -> codespace.v1.FailureDetail
	55, // 37: codespace.v1.ValidatePublicEndpointResponse.allowed:type_name -> codespace.v1.PublicEndpointAllowed
	70, // 38: codespace.v1.ValidatePublicEndpointResponse.denied:type_name -> codespace.v1.FailureDetail
	58, // 39: codespace.v1.VerifySSHPublicKeyResponse.allowed:type_name -> codespace.v1.SSHAuthBinding
	70, // 40: codespace.v1.VerifySSHPublicKeyResponse.denied:type_name -> codespace.v1.FailureDetail
	60, // 41: codespace.v1.ReportInstancesRequest.instances:type_name -> codespace.v1.RuntimeInstanceRef
	5,  // 42: codespace.v1.RuntimeInstanceRef.runtime_state:type_name -> codespace.v1.RuntimeState
	62, // 43: codespace.v1.ReportInstancesResponse.results:type_name -> codespace.v1.RuntimeInstanceResult
	44, // 44: codespace.v1.RuntimeInstanceResult.runtime_settings:type_name -> codespace.v1.EffectiveCodespaceRuntimeSettings
	8,  // 45: codespace.v1.RuntimeInstanceResult.action:type_name -> codespace.v1.RuntimeReconcileAction
	5,  // 46: codespace.v1.ReportRuntimeTransitionRequest.runtime_state:type_name -> codespace.v1.RuntimeState
	66, // 47: codespace.v1.RevalidateGatewaySessionRequest.endpoint:type_name -> codespace.v1.EndpointSessionBinding
	67, // 48: codespace.v1.RevalidateGatewaySessionRequest.ssh:type_name -> codespace.v1.SSHSessionBinding
	69, // 49: codespace.v1.RevalidateGatewaySessionResponse.allowed:type_name -> codespace.v1.SessionAllowed
	70, // 50: codespace.v1.RevalidateGatewaySessionResponse.denied:type_name -> codespace.v1.FailureDetail
...
func file_codespace_v1_types_proto_init() {
	...
	file_codespace_v1_types_proto_msgTypes[17].OneofWrappers = []any{
		(*DevContainerFeatureOption_StringValue)(nil),
		(*DevContainerFeatureOption_BoolValue)(nil),
	}
	file_codespace_v1_types_proto_msgTypes[37].OneofWrappers = []any{
	...
	file_codespace_v1_types_proto_msgTypes[59].OneofWrappers = []any{
